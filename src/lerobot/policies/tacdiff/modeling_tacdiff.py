...
class TacdiffPolicy(PreTrainedPolicy):
    """
    Diffusion Policy as per "Diffusion Policy: Visuomotor Policy Learning via Action Diffusion"
    (paper: https://huggingface.co/papers/2303.04137, code: https://github.com/real-stanford/diffusion_policy).
    """

    config_class = TacdiffConfig
    name = "tacdiff"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.diffusion = TacdiffPolicy(config)
...
class TacdiffModel(nn.Module):
    def __init__(self, config: TacdiffConfig):
        super().__init__()
        self.config = config
